...
$conf['settings']['app.title'] = 'West Bowie Public Witnessing Scheduler';
$conf['settings']['default.timezone'] = 'America/New_York';
$conf['settings']['allow.self.registration'] = 'true';
$conf['settings']['admin.email'] = 'shubbard11@gmail.com';
$conf['settings']['admin.email.name'] = 'West Bowie Public Witnessing Admin';
...
$conf['settings']['name.format'] = 'Steven Hubbard';
